...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/genno-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12883&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/genno-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `genno` can be installed with:

```
conda install genno
```

It is possible to list all of the versions of `genno` available on your platform with:
